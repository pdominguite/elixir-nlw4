defmodule Rocketpay.Accounts.Operation do
  ...
  defp handle_cast(:error, _value, :deposit), do: {:error, "Invalid deposit value!"}
  defp handle_cast(:error, _value, :withdraw), do: {:error, "Invalid withdraw value!"}
  defp handle_cast(:error, _value, _operation), do: {:error, "Invalid operation!"}
